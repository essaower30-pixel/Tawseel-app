...
export const DEFAULT_INITIAL_UPDATE: AppUpdateInfo = {
  id: "update_v2_5_0",
  version: "v2.5.0",
  title: "إطلاق التحديث الشامل: رنين الطلبات، واتساب الأعمال، واستمرارية العمل 🚀",
  releaseDate: "أغسطس 2026",
  features: [
    "تنبيهات فورية ورنين هاتف واقعي (Dual-Tone Telephony Chime) للطلبات الجديدة في لوحة الإدارة والكباتن والمتاجر",
    "تخصيص كامل لصوت ونغمة التنبيه مع خيار الكتم أو الاهتزاز ووميض شريط المتصفح",
    "دعم مباشر لمشاركة ومراسلة واتساب الأعمال (WhatsApp Business) والواتساب العادي",
    "حماية زر الرجوع وضمان استمرار استقبال الطلبات والرنين بالخلفية دون إغلاق التطبيق بالخطأ",
    "أيقونة إشعار التحديثات الذكية لإعلام المستخدمين بالميزات الجديدة فور صدورها من الإدارة",
    "تحسينات عامة على سرعة الاستجابة واستقرار التخزين الميداني"
  ],
  notes: "تم تجهيز هذا التحديث من قبل إدارة المنصة لتحسين تجربة الطلب والتوصيل وسرعة استجابة المتاجر والكباتن.",
  publishedAt: 1787880000000,
